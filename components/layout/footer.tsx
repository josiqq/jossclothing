...
function SocialIcon({ name, href, children }: { name: string; href: string; children: React.ReactNode }) {
  return (
    <Link
      ...
      className="flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 text-neutral-600 transition-colors hover:bg-neutral-200 hover:text-black"
  ...
  return (
    <footer className="text-sm text-neutral-500">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 border-t border-neutral-200 px-6 py-12 text-sm md:flex-row md:gap-12 md:px-4 min-[1320px]:px-0">
        <div>
          <Link className="flex items-center text-black gap-2 md:pt-1" href="/">
        ...
        <div className="flex flex-col gap-4 md:ml-auto">
          <h3 className="text-black font-medium">Síguenos</h3>
          <div className="flex gap-3">
            <SocialIcon name="Facebook" href="https://facebook.com/tu-pagina">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
              </svg>
            </SocialIcon>

            <SocialIcon name="Instagram" href="https://instagram.com/tu-cuenta">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <SocialIcon name="WhatsApp" href="https://wa.me/595123456789">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
